...
namespace DotaDude.Migrations
{
    ...
    [Migration("20250430094121_AddPreferredRole")]
    partial class AddPreferredRole
    {
            ...
            modelBuilder.Entity("DotaDude.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PreferredRole = "carry",
                            RegistrationDate = new DateTime(2025, 3, 31, 11, 41, 21, 697, DateTimeKind.Local).AddTicks(1321),
                            Username = "demouser"
                        });
                });
